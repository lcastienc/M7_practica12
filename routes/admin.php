...
//Por ejemplo: http://127.0.0.1:8000/adb/Clientes
//Eso nos llevara a la view de Clientes
Route::group(['middleware' => ['adb']], function(){
    // Ruta, /Clientes, donde se mostrara la pagina,la view, de Clientes
    Route::get('/Clientes', [ControladorAdmin::class, 'Clientes']);
    // Ruta, /Facturacion, donde se mostrara la pagina,la view, de Facturacion
