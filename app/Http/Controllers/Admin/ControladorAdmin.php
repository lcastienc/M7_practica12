...
class ControladorAdmin extends Controller
{
    ...
    //Funcion Facturacion, que sera llamada por la ruta /adb/Facturacion que nos mostrara la view Clientes
    //La view mostrara el mensaje que definamos dentro de esta funcion
    public function Facturacion() {
        return view('Facturacion') -> with(['mensajeFacturacion' => 'Bienvenidos, estamos en la pagina Facturacion']);
    }

    //Funcion Contabilidad, que sera llamada por la ruta /adb/Contabilidad que nos mostrara la view Clientes
    //La view mostrara el mensaje que definamos dentro de esta funcion
